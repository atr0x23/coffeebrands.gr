...
<!-- Navbar (sit on top) -->
 ...
 <div class="w3-top">
  <div class="w3-bar" id="myNavbar">
    ...
    <a href="../index2.php#home" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-home"></i> ΑΡΧΙΚΗ</a>
    <a href="../index2.php#about" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-user"></i> Η ΕΤΑΙΡΙΑ</a>
<!--
...
-->
    <a href="../index2.php#ourProducts" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-th"></i> ΠΡΟΙΟΝΤΑ</a>
    <a href="../index2.php#ourProducts" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-th"></i> MORNING HEROES</a>
    <a href="../index2.php#ourProducts" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-th"></i> CHILLCUP</a>
    <a href="../index2.php#ourProducts" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-map-marker"></i> JUICE SPOT</a>
    <a href="franchise.php" target="_blank" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-link"></i> FRANCHISE</a>
    <a href="../index2.php#shops" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-map-marker"></i> ΚΑΤΑΣΤΗΜΑΤΑ</a>
    <a href="../index2.php#shops" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-shopping-bag"></i> E-SHOP</a>
    <a href="../index2.php#contact" class="w3-bar-item w3-button w3-hide-small"><i class="fa fa-envelope"></i> ΕΠΙΚΟΙΝΩΝΙΑ</a>
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium">
    <a href="../index2.php#about" class="w3-bar-item w3-button" onclick="toggleFunction()">Η Εταιρεία</a>
    <a href="../index2.php#portfolio" class="w3-bar-item w3-button" onclick="toggleFunction()">Προϊόντα</a>
    <a href="franchise.php" class="w3-bar-item w3-button" target="_blank" onclick="toggleFunction()">Franchise</a>
    <a href="../index2.php#shopsMobile" class="w3-bar-item w3-button" onclick="toggleFunction()">Καταστήματα</a>
    <a href="../index2.php#e-shopMobile" class="w3-bar-item w3-button" onclick="toggleFunction()">E-shop</a>
    <a href="../index2.php#contact" class="w3-bar-item w3-button" onclick="toggleFunction()">Επικοινωνία</a>
